...
Mamy doczynienia z prosta grą na wzór `flappy bird` oraz mamy informację, że po uzyskaniu 9999 punktów dostaniemy flage

Idealnym narzędziem do rozwiązania tego taska jest [cheatengine](https://www.cheatengine.org/)
...
8. Klikamy Next Scan.
9. Powtarzamy proces aż zostanie 1–kilka adresów.
10. Po zawężeniu wyników:
zmieniamy wartości podejrzanych adresów ręcznie,
...
12. Wracamy do grę i zdobywamy ręcznie jeden punkt
