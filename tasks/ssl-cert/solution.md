...
Strona ta posiadała certyfikat SSL, z tego też powodu najprostrzym sposobem na jej odnalezienie 
...
Na stronie [crt.sh](https://crt.sh/) wpisujemy ```%.hack.krak.pl``` 
...
Po wejściu na ten adres mogliśmy otrzymać flagę.
